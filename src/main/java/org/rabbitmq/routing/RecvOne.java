...
public class RecvOne {
    //订阅者自身的队列
    private static final String QUEUE_NAME = "direct_queue_one"; //temporary queue
    //交换机名称
    ...
    public static void main(String args[]) throws Exception {
        ...
        //绑定队列到交换机
        channel.queueBind(QUEUE_NAME, EXCHANGE_NAME, "update"); //将消息队列绑定到交换机的时候会有一个routingKey来实现路由分配的功能
